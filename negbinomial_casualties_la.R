...
m1data <- subset(modeldata, City=="LA")
# write to csv
write.csv(m1data,"Master_Aggregated_LA.csv")
...
# RMSE of 38.00545
# AIC of 9354.3
# this is higher than the mean of 28.77628, sd of 28.95179
...
collisions <- subset(collisions, City=="LA") # change this out to LA
df_features_1 <- left_join(features_1, collisions, by = "GEOID")
# View(df_features_1)
# feature out df_features_1 for nyc
df_features_1 = subset(df_features_1, City=="LA")
write.csv(df_features_1, "df_features_1_la.csv", row.names = FALSE)
...
# View(df_features_2)
# df_features_2 = subset(df_features_2, City=="LA")
# write.csv(df_features_2, "df_features_2_la.csv", row.names = FALSE)
